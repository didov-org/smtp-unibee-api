...
func (c AlipayWebhook) GatewayNewPaymentMethodRedirect(r *ghttp.Request, gateway *entity.MerchantGateway) (err error) {
	return nil
}

func (c AlipayWebhook) GatewayCheckAndSetupWebhook(ctx context.Context, gateway *entity.MerchantGateway) (err error) {
	_ = query.UpdateGatewayWebhookSecret(ctx, gateway.Id, gateway.GatewaySecret)
	return nil
}

func (c AlipayWebhook) GatewayWebhook(r *ghttp.Request, gateway *entity.MerchantGateway) {
	...
	if jsonData.Contains("paymentId") {
		err = ProcessPaymentWebhook(r.Context(), jsonData.Get("paymentRequestId").String(), jsonData.Get("paymentId").String(), gateway)
		if err != nil {
...
func (c AlipayWebhook) GatewayRedirect(r *ghttp.Request, gateway *entity.MerchantGateway) (res *gateway_bean.GatewayRedirectResp, err error) {
