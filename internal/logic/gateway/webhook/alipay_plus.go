...
type AlipayPlusWebhook struct {
}

func (c AlipayPlusWebhook) GatewayNewPaymentMethodRedirect(r *ghttp.Request, gateway *entity.MerchantGateway) (err error) {
	return nil
}

func (c AlipayPlusWebhook) GatewayCheckAndSetupWebhook(ctx context.Context, gateway *entity.MerchantGateway) (err error) {
	_ = query.UpdateGatewayWebhookSecret(ctx, gateway.Id, gateway.GatewaySecret)
	return nil
}

func (c AlipayPlusWebhook) GatewayWebhook(r *ghttp.Request, gateway *entity.MerchantGateway) {
