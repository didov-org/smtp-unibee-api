...
type MerchantMetric struct {
	...
	Type                int         `json:"type"                description:"1-limit_metered，2-charge_metered,3-charge_recurring(come later)"` // 1-limit_metered，2-charge_metered,3-charge_recurring(come later)
