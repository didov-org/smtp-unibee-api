...
type Merchant struct {
	...
	IsDeleted     int         `json:"isDeleted"     description:"Unarchived: <= 0; Archived: > 0"` // Unarchived: <= 0; Archived: > 0
	...
	WebhookSecret string      `json:"webhookSecret" description:"merchant webhook secret"`         // merchant webhook secret
}
