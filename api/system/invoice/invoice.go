...
type QuickbooksSyncReq struct {
	g.Meta    `path:"/invoice_quickbooks_sync" tags:"System-Admin" method:"get" summary:"Admin Sync Invoice To Quickbooks"`
	InvoiceId string `json:"invoiceId" dc:"invoiceId" v:"required#Require invoiceId"`
}
type QuickbooksSyncRes struct {
}

type BatchSendInvoiceWebhookEventReq struct {
	g.Meta     `path:"/batch_sent_invoice_webhook_event" tags:"System-Admin" method:"post" summary:"Batch Send Invoice Webhook Event"`
	InvoiceIds []string `json:"invoiceIds" dc:"InvoiceIds" v:"required"`
}
type BatchSendInvoiceWebhookEventRes struct {
}
